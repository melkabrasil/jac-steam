function scr_textos(){
	...
	ds_grid_add_text("Que pergunta incrível, Jac! O ''S'' é sobre Science, que traduzindo, é Ciência no português.", 0, "Marie");
	ds_grid_add_text("O papel da Ciência é pesquisar e desvendar os mistérios do mundo, o que é essencial para entendermos como e por que cada coisa existe.",0, "Marie");
